  ...
  <div class="custom-table-wrapper">
    <div class="table-container" :style="{ height: tableContainerHeight }">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <!-- Пользовательский слот: в приоритете используется имя слота, указанное в column.slot, иначе используется column.prop в качестве имени слота -->
            <slot
...
export default {
  ...
  props: {
    ...
    // Показывать ли флажок выбора
    showSelection: {
      type: Boolean,
      default: false
    },
    // Показывать ли Столбец операций
    showOperations: {
      type: Boolean,
      default: false
    },
