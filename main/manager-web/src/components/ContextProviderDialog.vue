...
export default {
  ...
  methods: {
    initLocalData() {
      // Глубокое копирование и преобразование headers Объекты, преобразованные в массивы
      ...
      // Если пусто, добавить блок по умолчанию
...
.provider-card {
  ...
  border-left: 4px solid #409EFF; /* Цвет акцента слева */
...
.label-text {
  ...
  font-size: 13px;
  white-space: nowrap;
  line-height: 32px; /* Вертикальное центрирование */
}
