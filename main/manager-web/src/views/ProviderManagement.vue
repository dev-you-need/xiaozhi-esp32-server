<template>
  <div class="welcome">
    ...
    <!-- Новый/Диалоговое окно «Редактировать поставщика» -->
...
export default {
  ...
  data() {
    return {
      ...
      total: 0,
      dialogVisible: false,
      dialogTitle: "Добавить поставщика",
      isAllSelected: false,
      ...
      Api.model.getModelProvidersPage(
        ...
        ({ data }) => {
          ...
          if (data.code === 0) {
            ...
            this.$message.error({
              message: data.msg || 'Ошибка получения списка параметров'
            });
          }
        }
      );
